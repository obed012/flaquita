/* ============================================
   LOVE.JS - LÓGICA PRINCIPAL DEL ÁRBOL Y ANIMACIONES
   ============================================ */

   (function(window){

    // === FUNCIÓN: Número aleatorio entre min y max ===
    function random(min, max) {
        return min + Math.floor(Math.random() * (max - min + 1));
    }

    // === FUNCIÓN: Curva Bézier (para ramas suaves) ===
    ...
    // === FUNCIÓN: Verifica si un punto está dentro del corazón ===
    function inheart(x, y, r) {
        // Fórmula matemática del corazón: x^2+(y-(x^2)^(1/3))^2 = 1
    ...
    // ============================================
    // CLASE: Seed (Semilla/Corazón Inicial)
    // ============================================
    ...
    Seed.prototype = {
        ...
        drawText: function() {
            ...
            ctx.moveTo(0, 0);
            ctx.scale(0.75, 0.75);
            ctx.font = "12px Arial, Helvetica, sans-serif"; // Cambié fuente china
            ctx.fillText("haz clic aquí", 23, 16); // Texto en español
            ctx.restore();
        },
        clear: function() {
            var ctx = this.tree.ctx, cirle = this.cirle;
    ...
    // ============================================
    // CLASE: Footer (Línea base del árbol)
    // ============================================
    ...
    Footer.prototype = {
        draw: function() {
            ...
            ctx.save();
            ctx.strokeStyle = 'rgb(35, 31, 32)'; // Color de la base
    ...
    Branch.prototype = {
        ...
        draw: function(p) {
            ...
            ctx.save();
        	ctx.beginPath();
        	ctx.fillStyle = 'rgb(35, 31, 32)'; // Color de las ramas
